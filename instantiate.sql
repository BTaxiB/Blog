...
(
    ...
    `content_1`   VARCHAR(300) CHARACTER SET utf32 COLLATE utf32_general_ci DEFAULT NULL,
    `content_2`   VARCHAR(300) CHARACTER SET utf32 COLLATE utf32_general_ci DEFAULT NULL,
    `content_3`   VARCHAR(300) CHARACTER SET utf32 COLLATE utf32_general_ci DEFAULT NULL,
    `content_4`   VARCHAR(300) CHARACTER SET utf32 COLLATE utf32_general_ci DEFAULT NULL,
